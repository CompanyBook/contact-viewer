	...
	<body>
		...
		<div id="show-contact" class="content scaffold-show" role="main">
			...
			<ol class="property-list contact">
				...
				<g:if test="${contactInstance?.page}">
				<li class="fieldcontain">
					<span id="page-label" class="property-label"><g:message code="contact.page.label" default="Page" /></span>
					
						<span class="property-value" aria-labelledby="page-label"><g:link controller="page" action="show" id="${contactInstance?.page?.id}">${contactInstance?.page?.encodeAsHTML()}</g:link></span>
					
				</li>
				</g:if>
			
				<g:if test="${contactInstance?.pageStringId}">
				<li class="fieldcontain">
					<span id="pageStringId-label" class="property-label"><g:message code="contact.pageStringId.label" default="Page String Id" /></span>
					
						<span class="property-value" aria-labelledby="pageStringId-label"><g:fieldValue bean="${contactInstance}" field="pageStringId"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${contactInstance?.score}">
				<li class="fieldcontain">
					<span id="score-label" class="property-label"><g:message code="contact.score.label" default="Score" /></span>
					
						<span class="property-value" aria-labelledby="score-label"><g:fieldValue bean="${contactInstance}" field="score"/></span>
